...
import {streamChat, summaryPDF, gptCompletion, getWeatherWithGptChatCompletion} from '../controllers/chatController.js';
...
router.post('/api/chatgpt/chat', getWeatherWithGptChatCompletion);
